...
class MiniMaxNode {
    ...
    private void MakeChildren() {
        ...
        GameAction[] availableMoves = _state.GetMoves(_state.MyPacs.Count, _state.MyPacs);
        }
        else{
            
            GameAction[] availableMoves = _state.GetMoves(_state.Enemies.Count,_state.Enemies );
        }
